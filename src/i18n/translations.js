...
export const translations = {
  de: {
    ...
    catalog: {
      ...
      urkundeOnlyWithSong: "Nur mit Song bestellbar",
      urkundeActionBtn: "Song konfigurieren & Urkunde dazu",
      urkundePreviewBtn: "Urkunden-Beispiel ansehen",
      urkundeTag: "+ 9,99 € Add-on",
      items: {
        hochzeit: {
          badge: "Bestseller",
        ...
        urkunde: {
          ...
          categoryLabel: "Druckfertiges Song-Add-on",
          desc: "Das perfekte greifbare Geschenk zum Einrahmen: Hochauflösendes DIN A4 PDF mit persönlichem Liedtext, goldenem Siegel & scannbarem QR-Code zum direkten Abspielen. Nur in Kombination mit einem personalisierten Song bestellbar.",
        },
      },
      voucherBanner: {
    ...
    checkout: {
      ...
      certificateAddonDesc: "Druckfertiges DIN A4 PDF mit persönlichem Liedtext, goldenem Siegel & scannbarem QR-Code zum Einrahmen & Abspielen.",
  ...
  en: {
    ...
    catalog: {
      ...
      urkundeBadge: "Song Add-on",
      urkundeOnlyWithSong: "Only with song order",
      urkundeActionBtn: "Configure Song & Add Certificate",
      urkundePreviewBtn: "View Certificate Example",
      urkundeTag: "+ €9.99 Add-on",
      items: {
        hochzeit: {
          badge: "Bestseller",
        ...
        urkunde: {
          ...
          desc: "The perfect tangible keepsake gift for framing: High-resolution DIN A4 PDF with custom lyrics, golden seal & scannable audio QR code to play the song. Available only together with a custom song order.",
        },
      },
      voucherBanner: {
    ...
    checkout: {
      ...
      certificateAddonDesc: "Print-ready DIN A4 PDF with custom lyrics, golden seal & scannable audio QR code to play the song on your smartphone.",
